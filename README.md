...
approvisionnent, tel que la somme des coûts engagés est minimisée. Il existe deux branches, la version de base sur un terminal (branche cpp) et la version améliorée avec une interface graphique (branche main).
